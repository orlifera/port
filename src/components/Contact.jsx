        ...
        <div id="contact-list">
          ...
          <ul id="contatti">
            ...
            <li><a lang="en" id="whatsapp" href="https://wa.me/+393927958165" aria-label="Whatsapp">
              <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" className="icon">
                <path
